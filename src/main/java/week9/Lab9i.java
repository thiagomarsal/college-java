    ...
    public static int getValidInt(Scanner sIn, String question, String warning, int[] range) {
        ...
        do {
            ...
            try {
                ...
                if (range.length > 0) {
                    if (number < range[0] || number > range[range.length-1]) {
//                        System.out.printf("Invalid response. Only whole numbers between %s and %s are acceptable. \n", range[0], range[range.length - 1]);
    ...
    public static double getValidDouble(Scanner sIn, String question, String warning, double[] range) {
        ...
        do {
            ...
            try {
                ...
                if (range.length > 0) {
                    if (number < range[0] || number > range[range.length-1]) {
//                        System.out.printf("Invalid response. Only floating-point between %s and %s are acceptable. \n", range[0], range[range.length - 1]);
                        System.out.printf(warning);
                        input = "";
                    }
                }
...
//                        System.out.printf("Invalid response. Only %s are acceptable. \n", Arrays.asList(choices));
                        System.out.printf(warning);
                        input = "";
                    }
                }
